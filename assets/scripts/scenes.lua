...
scenes = {
    ...
    [3] = { name = "level_tiled_03", path = "./assets/scripts/scene_tiled_03.lua" },
    [4] = { name = "level_01",       path = "./assets/scripts/scene_level1.lua"   },
    [5] = { name = "level_02",       path = "./assets/scripts/scene_level2.lua"   },
    [6] = { name = "level_03",       path = "./assets/scripts/scene_level3.lua"   },
}
